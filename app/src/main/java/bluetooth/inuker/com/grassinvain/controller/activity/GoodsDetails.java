...
public class GoodsDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView detail_small,new_message_num;
    ...
    private void initView() {
        ...
        new_message_num= (TextView) findViewById(R.id.new_message_num);
        ...
        detail_big.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String s = TextUtil.fen2yuan(Integer.parseInt(productSDeatilBodies1.get(1).productFormatPrice));
        ...
        detail_small.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String s = TextUtil.fen2yuan(Integer.parseInt(productSDeatilBodies1.get(0).productFormatPrice));
                product_price.setText(s);
        ...
        Log.e("QQQQQQQQQQQQQQQQQQQ",TextUtil.fen2yuan(Integer.parseInt(productSDeatilBodies1.get(0).productFormatPrice)));
        product_price.setText(TextUtil.fen2yuan(Integer.parseInt(productSDeatilBodies1.get(0).productFormatPrice)));
        // 立即购买
        ...
        switch (view.getId()) {
            ...
            case R.id.jiarugouwuche:
                if (!CacheCenter.getInstance().isLogin()) {
                    ...
                    System.out.println("this is weishenme");
                    Log.e("weishenme______________",productsId+"-----"+productsFormatId);
                    userModel.getJoinShoppingCar(joinShoppingCarBody, new Callback<String>() {
                        @Override
                        public void onSuccess(String baseResult) {
                            System.out.println("this is tianjia"+baseResult);
                            i=0;
                            initData();
            ...
            case R.id.goumai:
                if (!CacheCenter.getInstance().isLogin()) {
                    ...
                    if (product_price.getText().toString().equals(TextUtil.fen2yuan(Integer.parseInt(productSDeatilBodies1.get(0).productFormatPrice)))) {
                        list.add(productSDeatilBodies1.get(0));
                        intent1.putExtra("product", (Serializable) list);
                    }
                    if (product_price.getText().toString().equals(TextUtil.fen2yuan(Integer.parseInt(productSDeatilBodies1.get(1).productFormatPrice)))) {
    ...
    private void initData() {
        ...
        pageBody.pageSize = 999;
        pageBody.pageNum = 1;
        userModel.getShopCarListone(pageBody, new Callback<ShopCarListBody>() {
            @Override
            public void onSuccess(ShopCarListBody shopCarListBody) {
                //list = shopCarListBody.list;
                //i=shopCarListBody.list.size();
                //
                for (int j=0;j<shopCarListBody.list.size();j++){
                    i+=Integer.parseInt(shopCarListBody.list.get(j).count);
                }
                new_message_num.setText(i+"");
            }
