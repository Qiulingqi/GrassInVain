    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.live_item_4:
                new AlertDialog.Builder(ChangePersonInformation.this).setTitle("离职申请")
                        .setMessage("你是真的需要离职吗？")
                        .setPositiveButton("确定",new DialogInterface.OnClickListener(){
                            ...
                            public void onClick(final DialogInterface dialog, int which) {
                                ...
                                info.isLeave="1";
                                userModel.getThrowWork(info, new Callback<Object>() {
                                    @Override
                                    public void onSuccess(Object o) {
                                        Toast.makeText(ChangePersonInformation.this,"离职申请成功",Toast.LENGTH_SHORT).show();
                                        dialog.dismiss();
                                    }
                                    @Override
                                    public void onFailure(int resultCode, String message) {
                                        Toast.makeText(ChangePersonInformation.this,"离职申请失败",Toast.LENGTH_SHORT).show();
                                    }
                                });
